    ...
    return (
        <React.Fragment>
            ...
            <ul>
                ...
                <li>WARNING! React-redux is installed and ready to be used (see App.jsx), as it described in requirements, but in case of the just only one form without requirements for further using the edited configuration Redux store is not connected to the form.</li>       
            </ul>
            <hr />
